...
public class Lista {
    private Nodo inicio;			// Puntero que indica el inicio de lista o cabeza de la lista.
    ...
    public void agregarAlFinal(String valor, int cantidad, String disponibilidad){		// Agrega un nuevo nodo al final de la lista.
        ...
        if (esVacia()) {					// Consulta si la lista esta vacia.
            ...
            Nodo aux = inicio;					 // Crea una copia de la lista.	// Caso contrario recorre la lista hasta llegar al ultimo nodo y agrega el nuevo.
